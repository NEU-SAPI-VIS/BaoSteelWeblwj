<template>
  <div>
        ...
        <el-table :data="tableData" style="width: 100%" :default-sort="defaultSort" border="">
          ...
          <el-table-column prop="auth" label="权限" align="center">
            <template slot-scope="scope">
              <p v-for="item in scope.row.auth">{{item}}</p>
            </template>
          </el-table-column>
    ...
    <!-- 更新用户弹出的对话框 -->
    <el-dialog title="更新角色" :visible.sync="ediDialogVisible" width="30%">
      <el-form ref="form" :model="editForm" label-width="80px">
        ...
        <el-form-item label="权限:">
          <el-select v-model="editForm.roles" multiple collapse-tags placeholder="请选择权限">
    ...
    <!-- 添加用户弹出的对话框 -->
    <el-dialog title="添加角色" :visible.sync="addUserVisible" width="30%">
      <el-form ref="form" :model="addUserForm" label-width="80px">
        ...
        <el-form-item label="权限:">
          <el-select v-model="addUserForm.roles" multiple collapse-tags placeholder="请选择权限">
            <el-option v-for="item in selectOptions" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
...
<script> 
import { roleData } from 'utils/data.js'
